...
void VenerisServer::configOpal() {
    ...
    if (forceNotUsingOpal) {
        ...
        std::cout<< check_and_cast<inet::physicallayer::IPrintableObject*>(getParentModule()->getModuleByPath(".radioMedium"))->getCompleteStringRepresentation()<<std::endl;
        std::cout<< check_and_cast<inet::physicallayer::IPrintableObject*>(getParentModule()->getModuleByPath(".radioMedium.pathLoss"))->getCompleteStringRepresentation()<<std::endl;
        std::cout<< check_and_cast<inet::physicallayer::IPrintableObject*>(getParentModule()->getModuleByPath(".radioMedium.backgroundNoise"))->getCompleteStringRepresentation()<<std::endl;
        std::cout<< check_and_cast<inet::physicallayer::IPrintableObject*>(getParentModule()->getModuleByPath(".radioMedium.mediumLimitCache"))->getCompleteStringRepresentation()<<std::endl;
...
void VenerisServer::createVehicle() {
    ...
    // OMNET modules seems to be stored in a linked list
    ...
    // TODO: we should keep track of removed and reinserted vehicles to merge the collected statistics

    cModule *module = moduleType->create("node", this->getParentModule(), id+1,id);
    ++activeVehiclesIndex;
